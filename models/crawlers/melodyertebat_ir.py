...
def melodyertebat(link, headers, site):
    try:
...
#
#
# item = MyObject("https://melodyertebat.ir/product/sennheiser-hd-26-pro/?utm_medium=PPC&utm_source=Torob")
# print(melodyertebat(item, None, None))
