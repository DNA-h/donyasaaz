...
def alandview(link, headers, site):
    try:
        ...
        try:
            elements = driver.find_elements(By.CSS_SELECTOR, ".nk_main_add_to_cart_box .price")
...
#
#
# item = MyObject("https://alandview.ir/product/rode-ai-micro-ultracompact-2x2-usb-type-c-audio-interface/")
# print(alandview(item, None, None))
