...
def behsazmusic(link, headers, site):
    try:
...
#
#
# item = MyObject("http://behsazmusic.ir/product/%d9%87%d9%86%da%af-%d8%af%d8%b1%d8%a7%d9%85-%d8%a2%d8%a8%db%8c-%d8%a2%d8%b1%d8%b4%d8%a7/?utm_medium=PPC&utm_source=Torob")
# print(behsazmusic(item, None, None))
