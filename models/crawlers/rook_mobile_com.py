...
def rook_mobile(link, headers, site):
    try:
        ...
        try:
            elements = driver.find_elements(By.CSS_SELECTOR, ".elementor-widget-xts_single_product_price .price")
...
#
#
# item = MyObject("https://electrocheshm.com/product/%d9%be%db%8c%d8%a7%d9%86%d9%88-%d8%af%db%8c%d8%ac%db%8c%d8%aa%d8%a7%d9%84-%db%8c%d8%a7%d9%85%d8%a7%d9%87%d8%a7-%d9%85%d8%af%d9%84-ydp-144/?utm_medium=PPC&utm_source=Torob")
# print(electrocheshm(item, None, None))
