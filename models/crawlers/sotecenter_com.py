...
def sotecenter(link, headers, site):
    try:
        ...
        if cart:
            elements = driver.find_elements(By.CSS_SELECTOR, '#product .product-price')
...
#
#
# item = MyObject("https://sotecenter.com/%DA%A9%D8%A7%D8%B1%D8%AA-%D8%B5%D9%88%D8%AA%DB%8C-motu-828x")
# print(sotecenter(item, None, None))
