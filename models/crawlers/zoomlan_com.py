...
def zoomlan(link, headers, site):
    try:
        ...
        try:
            elements = driver.find_elements(By.CSS_SELECTOR, "#default_deto")

            for element in elements:

                bdi = element.find_element(By.CSS_SELECTOR, '.green')
...
#
#
# item = MyObject("https://zoomlan.com/product/zp-776266/")
# print(zoomlan(item, None, None))