...
def kookgallery(link, headers, site):
    try:
        ...
        try:
            elements = driver.find_elements(By.CSS_SELECTOR, ".product-container p.price")
...
#
#
# item = MyObject("https://kookgallery.com/product/%DA%A9%D8%A7%D8%B1%D8%AA-%D8%B5%D8%AF%D8%A7-%D9%81%D9%88%DA%A9%D9%88%D8%B3-%D8%B1%D8%A7%DB%8C%D8%AA-%D9%85%D8%AF%D9%84-scarlett-solo-3rd-gen/")
# print(kookgallery(item, None, None))
