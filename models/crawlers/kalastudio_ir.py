        ...
        try:
            ...
            if elements:
                for element in elements:
                    price_text = element.find_element(By.CSS_SELECTOR, '.woocommerce-Price-amount')
                    price_text = convert_to_english(price_text.text.strip())
                    if price_text != "":
...
#         self.url = url
#
# item = MyObject("https://kalastudio.ir/product/marantz-mpm-1000/")
# print(kalastudio(item, None, None))
