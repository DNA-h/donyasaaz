...
def avlkala(link, headers, site):
    try:
        ...
        try:
            elements = driver.find_elements(By.CSS_SELECTOR, ".elementor-element-581c0742 .price .amount")
            ...
            try:
                elements = driver.find_elements(By.CSS_SELECTOR,
                                                '.elementor-element-581c0742 .price .amount')
                if elements:
                    for element in elements:
...
#
#
# item = MyObject("https://avlkala.com/product/beyerdynamic-dt-900-pro-x/?utm_source=EmallsCompairingPrice&utm_medium=EmallsPPC&utm_campaign=Emalls")
# print(avlkala(item, None, None))