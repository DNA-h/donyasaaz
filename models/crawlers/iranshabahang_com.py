...
def iranshabahang(link, headers, site):
    try:
        ...
        try:
            elements = driver.find_elements(By.CSS_SELECTOR, ".price-kharid-new .price")
...
#
#
# item = MyObject("https://iranshabahang.com/product/%D9%85%DB%8C%DA%A9%D8%B3%D8%B1-%DB%8C%D8%A7%D9%85%D8%A7%D9%87%D8%A7-mg12xu/?utm_medium=PPC&utm_source=Torob")
# print(iranshabahang(item, None, None))
