...
def sazbartar(link, headers, site):
    try:
...
#
#
# item = MyObject("https://sazbartar.com/product/%d9%87%d9%86%da%af-%d8%af%d8%b1%d8%a7%d9%85-%d8%a2%d8%b1%d8%b4%d8%a7-%d9%86%db%8c%d9%88-%d9%86%db%8c%d8%aa%d8%b1%d8%a7%db%8c%d8%af/?utm_medium=PPC&utm_source=Torob")
# print(sazbartar(item, None, None))
