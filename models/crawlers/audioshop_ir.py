...
def audioshop(link, headers, site):
    try:
...
#
#
# item = MyObject("https://audioshop.ir/product/%d8%a7%d9%85%d9%be%d9%84%db%8c-%d9%81%d8%a7%db%8c%d8%b1-vox-vx50-gtv/")
# print(audioshop(item, None, None))
