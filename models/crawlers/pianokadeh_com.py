...
def pianokadeh(link, headers, site):
    try:
        ...
        try:
            elements = driver.find_elements(By.CSS_SELECTOR, '#wz-product-price')
...
#
#
# item = MyObject("https://pianokadeh.com/shop/%D9%BE%DB%8C%D8%A7%D9%86%D9%88-%D8%AF%DB%8C%D8%AC%DB%8C%D8%AA%D8%A7%D9%84/P1213-casio-ap470.html")
# print(pianokadeh(item, None, None))
