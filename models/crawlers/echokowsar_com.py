...
def echokowsar(link, headers, site):
    try:
        ...
        # FIXED WOOCOMMERCE
        try:
            elements = driver.find_elements(By.CSS_SELECTOR, '.btn-green.product-addtocart')
            if elements :
...
#
#
# item = MyObject("https://echokowsar.com/digieco-4-speaker-set-2")
# print(echokowsar(item, None, None))
