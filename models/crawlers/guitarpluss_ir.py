...
def guitarpluss(link, headers, site):
    try:
...
#
#
# item = MyObject("https://www.guitarpluss.ir/product/%DA%AF%DB%8C%D8%AA%D8%A7%D8%B1-%D8%A8%D9%86%D8%A8%D8%B1%DA%AF-bg-491m/?utm_medium=PPC&utm_source=Torob")
# print(guitarpluss(item, None, None))
