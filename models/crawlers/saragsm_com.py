...
def saragsm(link, headers, site):
    try:
        ...
        try:
            elements = driver.find_elements(By.CSS_SELECTOR, ".price.single_price")
...
#
#
# item = MyObject("https://saragsm.com/shop/wh-1000xm4-wireless-noise-cancelling-headphones/?utm_medium=PPC&utm_source=Torob")
# print(saragsm(item, None, None))
