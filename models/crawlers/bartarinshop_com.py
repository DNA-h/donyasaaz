...
def bartarinshop(link, headers, site):
    try:
...
#
#
# item = MyObject("https://bartarinshop.com/product/motu-ultralite-mk5/?utm_medium=PPC&utm_source=Torob")
# print(bartarinshop(item, None, None))
