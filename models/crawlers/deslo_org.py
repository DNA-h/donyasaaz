...
def deslo(link, headers, site):
    try:
        ...
        try:
            elements = driver.find_elements(By.CSS_SELECTOR, ".add-order .green")
            if elements:
...
#         self.url = url
#
# item = MyObject("https://deslo.org/product/%DA%A9%DB%8C%D8%A8%D9%88%D8%B1%D8%AF%DB%8C%D8%A7%D9%85%D8%A7%D9%87%D8%A7_PSR-SX900")
# print(deslo(item, None, None))
